...
int addObjects(ClassX a, ClassY b) {
    return a.x + b.y;
}
...
int main() {
    ...
    cout << "=== Q1: Pointer to Object & this ===" << endl;
    q1();

    cout << "\n=== Q2: Swap using Friend Function ===" << endl;
    q2();

    cout << "\n=== Q3: Add Objects using Friend ===" << endl;
    q3();

    cout << "\n=== Q4: Friend Class ===" << endl;
    q4();

    cout << "\n=== Q5: Array of Objects (Rectangle) ===" << endl;
    q5();

    cout << "\n=== Q6: Inline Function ===" << endl;
    q6();

    cout << "\n=== Q7: Pass and Return Objects ===" << endl;
    q7();
